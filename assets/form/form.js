...
*/
  ...
  defaults = {
    ...
    // ZAMMAD_TRANSLATIONS_START
      ...
      'fa': {
        'Attachments': 'Ø¶Ù…Ø§ÛŒÙ…',
        'Email': 'Ø±Ø§ÛŒØ§Ù†Ø§Ù…Ù‡',
        'Message': 'Ù¾ÛŒØ§Ù…',
        'Name': 'Ù†Ø§Ù…',
        'Your Email': 'Ø§ÛŒÙ…ÛŒÙ„ Ø´Ù…Ø§',
        'Your Messageâ€¦': 'Ù¾ÛŒØ§Ù… Ø´Ù…Ø§â€¦',
      ...
      'ro': {
        ...
        'Message': 'Mesaj',
        'Name': 'Nume',
        'Your Email': 'AdresÄƒ de e-mail',
        'Your Messageâ€¦': 'Mesajul tÄƒuâ€¦',
        'Your Name': 'Numele tÄƒu',
      },
      'ru': {
      ...
      'sk': {
        'Attachments': 'PrÃ­lohy',
        'Email': 'E-mail',
        'Message': 'SprÃ¡va',
        'Name': 'Meno',
        'Your Email': 'VÃ¡Å¡ e-mail',
        'Your Messageâ€¦': 'VaÅ¡a sprÃ¡vaâ€¦',
        'Your Name': 'VaÅ¡e meno',
      },
      'sr': {
